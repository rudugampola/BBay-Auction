    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_date', models.DateTimeField(default=datetime.datetime(
                    2022, 10, 12, 4, 18, 19, 512856, tzinfo=datetime.timezone.utc))),
                ('image', models.ImageField(
                    default='upload/placeholder.png', upload_to='upload/')),
                ...
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE,
                 related_name='listings_same_category', to='auctions.category')),
                ('creator', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT,
                 related_name='all_listings', to=settings.AUTH_USER_MODEL)),
                ('watchers', models.ManyToManyField(blank=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('buyer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                 related_name='sale_buyer', to=settings.AUTH_USER_MODEL)),
                ...
                ('seller', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                 related_name='sale_seller', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Profits',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_date', models.DateTimeField(default=datetime.datetime(
                    2022, 10, 12, 4, 18, 19, 527856, tzinfo=datetime.timezone.utc))),
                ('listing', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                 related_name='user_comment', to='auctions.listing')),
                ('user', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
